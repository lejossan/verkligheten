<?php $title = "Butik"; include('header.php'); ?>
  ...
  <div class="section container">
    <div class="col--12">
      ...
      <p>Här hittar du allt från tvål, textilier till dukning och bad, köksredskap till glass och prylar till utflykten och grillen. Vi väljer våra produkter med omsorg och vårt fokus ligger på att välja produkter som håller länge och där både tillverkning och användande sker på ett miljösmart sätt. </p>
      ...
      <p>Ibland ordnar vi även marknader, då bjuder vi in lite fler försäljare och hantverkare. Då har vi även fikaservering och möjlighet att hälsa på gårdens djur. </p>
      <br/>
      <p class="col--6 mb">Betalning sker med kort, kontant eller Swisch.</p>
    <div>
      <h3 class="mt">ÖPPETTIDER</h3>
      <ul class="col--6 listbox mb">
        <li><span class="mr">Lördagar</span> <span>11-17</span></li>
      </ul>
