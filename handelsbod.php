<?php $title = "Butik"; include('header.php'); ?>
  ...
  <div class="section container">
    <div class="col--12">
      ...
      <p>Här hittar du allt från friluftsprylar som kåsor, sporkar till tvål, spel, köksredskap och glass. Vi väljer våra produkter med omsorg och vårt fokus ligger på att välja produkter som håller länge och där både tillverkning och användande sker på ett miljösmart sätt. </p>
    ...
    <div>
      ...
      <ul class="col--6 listbox mb">
        <li><span class="mr">Lördagar</span> <span>10:30-17</span></li>
      </ul>
