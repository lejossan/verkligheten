<?php
  ...
  echo '<h2>VÅRMARKNAD</h2>';

  echo '<p>Kom och hälsa på våra djur, ta en fika i trädgården eller kolla in vår lilla loppis. I stallet hittar du en liten butik med bland annat ekologiska rengöringsprodukter, tvålar, tovat och säkert några grönsaksplantor.  </p>
