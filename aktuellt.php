<?php $title = "Saker som händer"; include('header.php'); ?>
  ...
  <div class="section container">
      <?php include('texts/varmarknad.php'); ?>
  </div>
  <div class="section container">
      <div class="col--6">
        <a href="../img/var/hyllor.jpg" data-fancybox="varmarknad" data-caption="I stallet finns en butik.">
        <img class="" src="../img/var/hyllor.jpg" alt="hyllor" />
        </a>
      </div>
    </div>
    <div class="section container">
      <div class="col--3">
        <a href="../img/var/ecogrow.jpg" data-fancybox="varmarknad" data-caption="Ekologiska fröer">
        <img class="" src="../img/var/ecogrow.jpg" alt="ecogrow" />
        </a>
      </div>
      <div class="col--3">
        <a href="../img/var/kycklingar.jpg" data-fancybox="varmarknad" data-caption="Nya kycklingar finns på gården.">
        <img class="" src="../img/var/kycklingar.jpg" alt="folly" />
        </a>
      </div>
  </div>

  <div class="section container">
    <?php include('texts/julmarknad.php'); ?>
