<?php include('header.php'); ?>
  ...
  <div class="imagewrapper--big wood">
    ...
    <h1><a href="index.html" class="nolink" alt="home">VERKLIGHETENS GÅRD</a></h1>
      ...
      <li class="h3"><a href="#kontak">KONTAKT</a></li>
      </ul>
  </div>
  ...
  <div class="section white">
    <div class="container">
      <div class="col--6 right-align">
        ...
        <a class="readmore" href="">Läs mer om våra får och lamm här</a>
      </div> 
      <div class="col--6">
        <img class="lamm" src="../img/lamm.png" alt="lamm" title="lamm"/>
      </div>
    </div>
  </div>
  ...
  <div class="section">
    <div class="container">
      ...
      <div class="col--6 left-align">
        ...
        <a class="readmore" href="bygg.html">Läs mer om bygget här.</a>
      </div>
    </div>
  </div>
  ...
  <div class="section social">
    ...
    <div class="container">
      <a class="odlaiverkligheten col--6 nolink" href="http://www.instagram.com/odlaiverkligheten">
      ...
      <a class="djuriverkligheten col--6 nolink" href="http://www.instagram.com/djuriverkligheten">
